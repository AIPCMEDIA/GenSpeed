...
public sealed class Loc : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, string[]> Strings = new()
    {
        ...
        ["clean.banner"]    = ["Choisis ce que tu veux retirer, dans l'ordre des étapes. RIEN n'est supprimé sans ton accord, et tout est sauvegardé avant.",
                               "Choose what to remove, following the step order. NOTHING is deleted without your consent, and everything is backed up first."],
        ...
        ["clean.checkall"]  = ["☑ Tout cocher / décocher", "☑ Check / uncheck all"],
        ...
        ["clean.explain.options"]  = ["Réglages du jeu (résolution, audio…). Le retirer remet les options par défaut.", "Game settings (resolution, audio…). Removing it resets options to default."],
